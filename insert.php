...
<body>
    <div class="wrapper">
        ...
        <!-- content start -->
        <div class="content">
            <form action="insert.php" method="POST" class="insert-news" enctype="multipart/form-data">
                ...
                <input type="text" name="newsTitle" id="" class="input-des-insert">
                <p class="insert-des">Thể loại</p>
                <input type="text" name="newsGenre" id="" class="input-des-insert">
                <p class="insert-des">Nội dung</p>
                <textarea id="" name="newsTextContent" rows="10" cols="100" style="padding: 0 8px; outline: none;"></textarea>
                <input type="submit" value="Tải lên" name="insertBtn" class="insertSubmitBtn">
            </form>
        </div>
        <?php
        $conn = mysqli_connect("localhost", "root", "", "news");
            ...
            if (isset($_POST['insertBtn'])) {
                ...
                $newsTextContent = $_POST['newsTextContent'];

                $dirNewsImage = "assets/image/news image/";
                $image_path = $dirNewsImage . basename($_FILES['newsImage']['name']);
                move_uploaded_file($_FILES['newsImage']['tmp_name'], $image_path);
                ...
                $dirOfficeImage = "assets/image/editorial office/";
                 ...
                 $b = basename($_FILES['newsOfficeImage']['name']);
                    ...
                    $sql = "INSERT INTO news(userUploadID, newsImage, newsTitle, textContent, officeImage, genre) VALUES ('$userID','$a','$newsTitle','$newsTextContent','$b','$newsGenre')";
